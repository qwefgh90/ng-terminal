...
describe('Input properties', () => {
  ...
  it("@Input('rows'), @Input('cols')", fakeAsync(() => {
    ...
    component.ngOnChanges({
      rows: new SimpleChange(undefined, undefined, true),
      cols: new SimpleChange(undefined, undefined, true),
      draggable: new SimpleChange(undefined, undefined, true),
    });
    tick(1000);
    ...
    component.cols = 4;
    component.ngOnChanges({
      rows: new SimpleChange(undefined, 4, false),
      cols: new SimpleChange(undefined, 4, false),
    });
    tick(1000);
  ...
  it('should increase div size after changing fixedSize', fakeAsync(() => {
    ...
    component.cols = 100;
    component.ngOnChanges({
      rows: new SimpleChange(undefined, 100, false),
      cols: new SimpleChange(undefined, 100, false),
    });
    fixture.detectChanges();
    tick(1000);
